...
const FALLBACK_IMG =
  "https://via.placeholder.com/600x400.png?text=Image+Unavailable";
...
// This runs on the server — App Router components are async by default
export default async function Home() {
  const imgUrl =
    "https://user-gen-media-assets.s3.amazonaws.com/gpt4o_images/a2390567-d04c-4210-9c81-f693f14c5364.png";
    ...
    <Particles />
      ...
      <section className="hero" id="hero">
        <div
          ...
          style={{
            backgroundImage:
              "url('https://user-gen-media-assets.s3.amazonaws.com/gpt4o_images/8352916b-3239-426f-929f-08721fb4a692.png')",
          }}
        ></div>
        ...
        <div className="container">
          <div className="features-header">
            <h2 className="section-title">
              AI Chat Automation That Actually Works
            </h2>
            <p className="section-subtitle">
              Handle unlimited conversations while your team focuses on closing
              deals
            </p>
          </div>
            ...
            <div className="features-content">
              <div className="feature-card">
                ...
                <div className="feature-content">
                  ...
                  <p>
                    Handle unlimited conversations across WhatsApp, phone, and
                    web chat with intelligent AI agents.
                  </p>
                </div>
              </div>
              <div className="feature-card">
                ...
                <div className="feature-content">
                  ...
                  <p>
                    Qualify prospects instantly while your team sleeps. Never
                    lose another lead to slow response times.
                  </p>
                </div>
              </div>
              <div className="feature-card">
                ...
                <div className="feature-content">
                  ...
                  <p>
                    Automatically sync qualified leads to your CRM with complete
...
<section className="dashboard-preview">
    ...
    <section className="testimonials">
        <div className="container">
            ...
            <div className="testimonials-showcase" style={{backgroundImage: "url('https://user-gen-media-assets.s3.amazonaws.com/gpt4o_images/b095754e-bb79-4278-90e4-ee3c3287fb17.png')"}}></div>
